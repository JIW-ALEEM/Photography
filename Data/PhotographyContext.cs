...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BlogId).HasName("PK__Blogs__54379E50A55FA570");
        ...
        {
            entity.HasKey(e => e.BookingId).HasName("PK__Bookings__73951ACD49256F30");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__Comments__C3B4DFAAA4C1A5A9");
        ...
        {
            entity.HasKey(e => e.LikeId).HasName("PK__Likes__A2922CF4D8864D75");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__Notifica__20CF2E324084C4C3");
        ...
        {
            entity.HasKey(e => e.PhotoId).HasName("PK__Photos__21B7B58229483FB9");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__PhotoCat__19093A2B577BD085");
        ...
        {
            entity.HasKey(e => e.PlanId).HasName("PK__Plans__755C22D76E92E26B");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Role__8AFACE1AB555DDF6");
        ...
        {
            entity.HasKey(e => e.TestimonialId).HasName("PK__Testimon__91A23E534FD784A1");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCAC4535BCF1");

            entity.HasIndex(e => e.UserEmail, "UQ__Users__08638DF88F034DA6").IsUnique();
